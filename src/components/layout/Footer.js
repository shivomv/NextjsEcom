    ...
    <footer className="bg-pattern-dots pt-12 pb-28 md:pb-8 text-text">
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-white/90 text-sm sm:text-base">
                Get notified about new products and upcoming festivals
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 mb-8">
          ...
          <div className="border-b border-gray-200 pb-4 sm:border-0 sm:pb-0">
            ...
            >
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className={`h-5 w-5 transition-transform sm:hidden ${
            ...
            <div
              className={`${
                expandedSection === "about" ? "block" : "hidden sm:block"
              }`}
            >
          ...
          <div className="border-b border-gray-200 pb-4 sm:border-0 sm:pb-0">
            ...
            <div
              className={`${
                expandedSection === "links" ? "block" : "hidden sm:block"
              }`}
            >
              <ul className="space-y-2">
                <li>
                  <Link
                    href="/about"
                    className="text-text-light hover:text-gradient-purple-pink transition-colors flex items-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="border-b border-gray-200 pb-4 sm:border-0 sm:pb-0">
            ...
            <div
              className={`${
                expandedSection === "categories" ? "block" : "hidden sm:block"
              }`}
            >
              <ul className="space-y-2">
                {!categoriesLoading ? (
                  // Display non-festival categories from database
                  parentCategories
                    .filter(category => !category.isFestival)
                    .map((category) => (
                      <li key={category._id}>
                        <Link
          ...
          <div className="border-b border-gray-200 pb-4 sm:border-0 sm:pb-0">
            ...
            >
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className={`h-5 w-5 transition-transform sm:hidden ${
                  expandedSection === "festivals" ? "transform rotate-180" : ""
                }`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
            ...
            <div
              className={`${
                expandedSection === "festivals" ? "block" : "hidden sm:block"
              }`}
            >
              <ul className="space-y-2">
                {!categoriesLoading && festivalCategories.length > 0 ? (
                  ...
                  // Fallback festivals while loading
                  <>
                    <li>
                      <Link
                        href="/category/diwali"
                        className="text-text-light hover:text-primary transition-colors"
                      >
                        Diwali
                      </Link>
          ...
          <div className="border-b border-gray-200 pb-4 sm:border-0 sm:pb-0">
            ...
            <div
              className={`${
                expandedSection === "contact" ? "block" : "hidden sm:block"
              }`}
            >
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2 mt-0.5 text-gradient-purple-pink"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <li className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2 text-gradient-purple-pink"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
        ...
        <div className="border-t border-gradient-purple-pink pt-6 text-center text-sm text-text-light">
          <p>
            &copy; {new Date().getFullYear()} Prashasak Samiti. All rights
            reserved.
          </p>
          <div className="mt-2 space-x-4">
            <Link
              href="/privacy-policy"
              className="hover:text-gradient-purple-pink transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
