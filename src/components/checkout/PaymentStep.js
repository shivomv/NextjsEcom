...
export default function PaymentStep({ paymentMethod = '', onSubmit, onBack }) {
  ...
  const paymentMethods = [
    ...
    },
    {
      ...
      description: 'Pay using Visa, Mastercard, RuPay, or any other card',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {selectedMethod === 'Wallet' && (
          <div className="mb-8">
            <div className="bg-blue-50 p-4 rounded-md">
              <p className="text-sm text-blue-700">
                You will be redirected to your selected wallet provider to complete the payment after reviewing your order.
              </p>
            </div>
          </div>
        )}
