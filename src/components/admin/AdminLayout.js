...
export default function AdminLayout({ children }) {
  ...
  const isAdmin = isClient && isAuthenticated && user?.role === 'admin';
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      >
        ...
        <div className="absolute bottom-0 w-full border-t border-primary-dark p-4">
          <button
            onClick={logout}
            className="flex items-center w-full px-2 py-2 text-sm font-medium text-white rounded-md hover:bg-primary-light"
          >
            <LogoutIcon />
